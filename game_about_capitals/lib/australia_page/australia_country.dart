...
import 'package:game_about_capitals/australia_page/australia_class.dart';
                    ...
                    Row(
                      children: [
                        InkWell(
                          ...
                          highlightColor: const Color.fromARGB(255, 217, 68, 14).withOpacity(0.9),
                          splashColor: const Color.fromARGB(255, 222, 229, 25).withOpacity(0.9),
                          onTap: () {
